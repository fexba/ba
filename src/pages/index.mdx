...
<Button
  ...
  as="a"
  variant="success"
  href="https://github.com/fexba/ba"
  target="_blank"
>
  🌏View theme on GitHub
</Button>

<Link sx={{ whiteSpace: 'nowrap',color:'#fff',fontSize:'20px',textDecoration:'none' }} href="https://github.com/fexba/ba" target="_blank"> 🌏 面霸</Link>
</Grid>
...
<Link href="https://github.com/fexba/ba" variant="styles.a" target="_blank">
